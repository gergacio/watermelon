    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <Card className="rounded-sm">
        <CardContent className="pt-6">
          ...
          {/* Article pdf viewr - Display if exists */}
          {article.imageUrl && (
            <div className="mb-8">
              <div className="relative w-full h-96 md:h-96 overflow-hidden min-height: 100vh">
                <Card className="p-2 h-96 border-none shadow-none aspect-auto">
                  <embed
